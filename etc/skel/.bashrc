...
alias unhide-gnome-startup-applications="sudo sed -i 's/NoDisplay=true/NoDisplay=false/g' /usr/share/gnome/autostart/*.desktop "
alias unity-reset="rm -rf $HOME/.cache $HOME/.config/dconf $HOME/.gconf "
alias gnome-reset="rm -rf $HOME/.cache $HOME/.config/dconf $HOME/.gconf "
alias kde-reset="rm -rf $HOME/.kde "
